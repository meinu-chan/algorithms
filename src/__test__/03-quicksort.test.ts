...
import { quicksort, quicksortWithRandomPivot } from '../03-quicksort'
...
describe('quick sort with random pivot', () => {
  it("should correctly sort number's array", () => {
    const unsortedNumberArray = [2, 1, 0, 45, 21, 34]

    const sortedArray = quicksortWithRandomPivot(unsortedNumberArray)
